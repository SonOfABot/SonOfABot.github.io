...
{% assign writeups = site.pages | where_exp: "p", "p.date" | sort: "date" | reverse %}
...
<div class="terminal">
  ...
  <div class="terminal-body">
    <p class="command">sonofabot@system:~$ cat latest.txt</p>
    <p><a href="/Posts/Pwn-College/baseball.html">Henry Can't Make Tryouts So I Became Him Instead</a> — model evasion against a Gaussian Process Classifier, hill climbing vs saliency maps vs gradient descent vs greedy construction, benchmarked head to head. <em>pwn.college / Model Evasion</em></p>
  </div>
</div>
